"""
Advanced Axis Colleges AI Assistant with OpenAI Integration
Intelligent NLP-powered chatbot with context memory and structured knowledge base
"""
...
SAMPLE_COURSES = [
    {
        ...
        'short_name': 'CSE',
        'alternate_names': ['b.tech cse', 'computer science', 'cse engineering', 'bt computer'],
        'duration': '4 Years',
    ...
    },
    {
        ...
        'short_name': 'BCA',
        'alternate_names': ['bca', 'computer applications', 'bachelor computer applications'],
        'duration': '3 Years',
    ...
    },
    {
        ...
        'short_name': 'BBA',
        'alternate_names': ['bba', 'business administration', 'bachelor business'],
        'duration': '3 Years',
    ...
    },
    {
        ...
        'short_name': 'MBA',
        'alternate_names': ['mba', 'master business', 'business management'],
        'duration': '2 Years',
...
class AdvancedAIAssistant:
    ...
    def _build_intent_patterns(self) -> Dict[str, List[str]]:
        """Build intent recognition patterns with Hinglish support"""
        return {
            'course': ['course', 'program', 'study', 'btech', 'bca', 'bba', 'mba', 'mca', 'engineering', 'degree', 'branch', 'stream', 
                      'padhai', 'padhna', 'course ka', 'konse course', 'best course', 'which course'],
            'event': ['event', 'fest', 'function', 'program', 'celebration', 'workshop', 'seminar', 'competition', 'cultural', 'technical fest', 'sports meet', 'upcoming events', 'next event', 'event schedule', 'college events', 'campus events', 'event details', 'event kab hai', 'next fest kab hai', 'events kya hai', 'upcoming events kya hai'], 
            'fee': ['fee', 'fees', 'cost', 'price', 'payment', 'charges', 'expense', 'tuition', 'semester', 'fees kitna', 
                     'kharcha', 'kitna fees', 'total fees', 'course fees', 'semester fees', 'admission fees'],
            'admission': ['admission', 'apply', 'application', 'process', 'enroll', 'register', 'join', 'entrance', 'admission kaise',
                        'admission process', 'kab admission', 'form kab', 'entrance exam', 'counselling'],
            'placement': ['placement', 'job', 'company', 'package', 'salary', 'campus', 'recruit', 'interview', 'offer', 'placement kaisa',
                       'package kitna', 'company aati hai', 'campus placement', 'job placement', 'career'],
            'facility': ['facility', 'facilities', 'hostel', 'library', 'lab', 'sports', 'campus', 'wifi', 'transport', 
                        ...
                        'hostel milti hai', 'library hai', 'wifi hai', 'sports ground', 'mess', 'cafeteria'],
            'contact': ['contact', 'phone', 'email', 'address', 'call', 'reach', 'location', 'office', 'helpline', 'contact number',
                       'phone number', 'address kya hai', 'call kaise', 'office location'],
            'scholarship': ['scholarship', 'financial', 'aid', 'grant', 'waiver', 'discount', 'support', 'fund', 'scholarship milta hai',
                         'fee waiver', 'chhatrav', 'financial help'],
            'comparison': ['compare', 'difference', 'better', 'vs', 'versus', 'between'],
            'eligibility': ['eligibility', 'criteria', 'requirement', 'qualified', 'eligible'],
            'unknown': []
        }
    ...
    def _generate_fallback_response(self, intent: str) -> str:
        ...
        if not self._is_college_related(intent):
            return "🤖 I am designed to assist with Axis College related queries only. I can help you with information about courses, fees, admissions, placements, facilities, and more about Axis Colleges, Kanpur. How can I assist you with Axis Colleges?"
        
        return "🤔 I apologize, but I don't have specific information about that. However, I can help you with details about our courses, admission process, fees, placements, facilities, and other Axis College services. What would you like to know?"
...
Provide a helpful, professional response:"""
    ...
    def _generate_rule_based_response(self, message: str, intent: str, context: List[Dict]) -> str:
        ...
        if intent == 'course':
            ...
            return "🎓 **Complete Admission Guide for Axis Colleges:**\n\n" \
                   "**📋 Eligibility Criteria:**\n" \
                   "- Minimum 50% marks in 10+2 for all courses\n" \
                   "- 60% marks required for B.Tech programs\n" \
                   "- Valid through any recognized board\n\n" \
                   "**📝 Step-by-Step Admission Process:**\n" \
                   "1. **Registration:** Fill application form online/offline\n" \
                   "2. **Document Submission:** Submit all required documents\n" \
                   "3. **Entrance Exam:** Appear for university/conducted entrance test\n" \
                   "4. **Counselling:** Participate in counseling process\n" \
                   "5. **Merit List:** Check selected candidates list\n" \
                   "6. **Fee Payment:** Complete admission fee payment\n" \
                   "7. **Confirmation:** Receive admission confirmation\n\n" \
                   "**📄 Required Documents:**\n" \
                   ...
                   "- Admission Fee: Part of first semester fees\n\n" \
                   "**📅 Important Dates:**\n" \
                   "- Form Start: March 1st\n" \
                   "- Form Last Date: July 15th\n" \
                   "- Entrance Exam: July 20-25\n" \
                   "- Result: August 5th\n" \
                   "- Counseling: August 10-20\n\n" \
                   "📞 **Admission Helpline:** 0512-2580002\n" \
                   "🌐 **Online Portal:** www.axiscolleges.edu.in/admission"
